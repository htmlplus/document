...
import { Grid, Sticky } from '@htmlplus/react';
const StickySidebar = () => {
  return (
...
const StickySidebarExample = () => {
  return (
    <div className="ex-sticky-sidebar dock">
      <StickySidebar />
      <style>{`.ex-sticky-sidebar .container {  height: 20rem;  overflow: auto;}.ex-sticky-sidebar .container p {  margin: 0;  padding: 1rem;  text-align: justify;}.ex-sticky-sidebar aside,.ex-sticky-sidebar header {  background: lightgray;  text-align: center;  padding: 1rem;}`}</style>
    </div>
  )
};

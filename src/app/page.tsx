...
import FavouriteTools from "@/components/Favourite-tools";
              ...
              <div className="flex flex-col items-center gap-8 laptop:items-start basis-1/2">
                ...
                <div className="flex flex-col items-center gap-6 laptop:items-start text-center laptop:text-start">
                  ...
                  <div className="w-full">
                    <div
                        className="flex flex-col gap-4 tablet:flex-row items-stretch justify-center laptop:justify-start laptop:items-center">

...
import { AppLoadingBar, Contributors, Frameworks, Navigation, Sidebar } from '@/containers';
            ...
            <plus-grid>
              ...
              <plus-grid-item xs="12" md="auto" hide-md-down>
                <plus-sticky class="sidebar-end">
                  ...
                  <br />
                  <p>Contents</p>
                  <plus-scroll-spy-target smooth-scroll type-property="localName"></plus-scroll-spy-target>
                </plus-sticky>
              </plus-grid-item>
            </plus-grid>
          </plus-grid-item>

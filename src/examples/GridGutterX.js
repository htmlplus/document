...
const GridGutterX = () => {
  return (
    <div className="grid-gutter-x">
      <App />
      <style>{`.grid-gutter-x { plus-grid div {  color: #00bcd4;  border: 1px solid #ffffff;  background-color: #e0f7fa;  padding: 0.5em;  text-align: center;} }`}</style>
    </div>
  )
};

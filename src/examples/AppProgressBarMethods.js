...
const AppProgressBarMethods = () => {
  return (
    <div className="app-progress-bar-methods">
      <App />
      <style>{`.app-progress-bar-methods { plus-app-progress-bar {  /* This style is for demonstration purposes only and not for actual projects */  position: static;} }`}</style>
    </div>
  )
};

export default AppProgressBarMethods;

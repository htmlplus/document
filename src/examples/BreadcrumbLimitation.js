...
const BreadcrumbLimitation = () => {
  return (
    <div className="breadcrumb-limitation">
      <App />
      <style>{`.breadcrumb-limitation { plus-breadcrumb a {  color: inherit;  text-decoration: none;}plus-breadcrumb a:hover {  text-decoration: underline;} }`}</style>
    </div>
  )
};

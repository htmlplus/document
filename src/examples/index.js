...
export const PortalDefault = dynamic(() => import('./PortalDefault'), { suspense: true });
export const PortalStrategy = dynamic(() => import('./PortalStrategy'), { suspense: true });
export const ScrollDetectorDefault = dynamic(() => import('./ScrollDetectorDefault'), { suspense: true });
export const ScrollIndicatorDefault = dynamic(() => import('./ScrollIndicatorDefault'), { suspense: true });

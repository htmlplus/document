...
const AvatarSlots = () => {
  return (
    <div className="avatar-slots">
      <App />
      <style>{`.avatar-slots { plus-avatar > div {  background-color: gray;  color: white;  font-size: 10px;  padding: 0.125rem 0.25rem;  font-family: monospace;  line-height: 1;} }`}</style>
    </div>
  )
};
